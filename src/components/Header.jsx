  ...
  return (
    <>
      ...
      <nav className="hidden md:block bg-transparent relative z-50 pt-1 m-0">
        <div className="max-w-[1140px] mx-auto pl-1 ">
          <div
            className="flex justify-between items-center xl:px-0 lg:px-2 md:px-4 h-[52px] gap-2 text-[13px] md:text-[12px] lg:text-[15px] text-white font-[600] w-full transition-all duration-500 ease-out"
            style={{ letterSpacing: "0.2px" }}
          >
            {navItemWithDropdown("ABOUT US", "about", true)}
            {navItemWithDropdown("SERVICES", "services")}
