...
//           <IoMdArrowDropdown
//             className={` text-[24px] transition-all duration-500 ease-out ${
...
//           <div
//             className="flex justify-between items-center h-[52px] gap-2 text-[15px] text-white font-[600] w-full transition-all duration-500 ease-out  "
...
//             <Link
//               to="/pricing"
//               className="hover:text-red-400 transition-all duration-500 ease-out"
//             >
//               PRICING
//             </Link>
//             <Link
...
//             <div
//               className="  relative w-[90%] max-w-[600px] bg-gradient-to-b from-[#427fdf] to-[#396bb1] rounded-lg shadow-lg
...
export default function HeaderBlue() {
    ...
    >
      <Link
        ...
        className={`flex items-center ${
          ...
          text-[#3467d8] group-hover:text-red-400 transition-all duration-500 ease-out py-[15px]  text-[13px] sm:text-[12px] lg:text-[15px]`}
      >
        <p className="flex items-center">
          {label}
          <IoMdArrowDropdown
  ...
  return (
    <>
      {/* <Navbar /> */}
      <nav className="hidden md:block  relative z-50 pt-1 m-0">
        <div className="max-w-[1140px] mx-auto pl-1 ">
          <div
            className="flex justify-between items-center xl:px-0 lg:px-2 md:px-4 h-[52px] gap-2 text-[13px] md:text-[12px] lg:text-[15px] text-[#3467d8] font-[600] w-full transition-all duration-500 ease-out"
            style={{ letterSpacing: "0.2px" }}
          >
            {navItemWithDropdown("ABOUT US", "about", true)}
            {navItemWithDropdown("SERVICES", "services")}
            <Link
              to="/pricing"
              className="text-[13px] md:text-[12px] lg:text-[15px] hover:text-red-400 transition-all duration-500 ease-out"
            >
              PRICING
            </Link>
            <Link
