...
//                 <div className=' flex gap-4 p-4 items-center border rounded-[10px] pr-24 hover:bg-[#011833] text-[#011833] hover:text-white  transition-transform w-[440px]'>
//                     <FaWhatsapp className=' text-[#3467d8]  text-[45px]' />
//                     <div className=''>
//                         <h1 className=' text-[#011833] text-[22px] font-[600] '>Whatsapp Directly</h1>
...
//                     <div className=''>
//                         <h1 className=' text-[#011833] text-[22px] font-[600] '>Email Us Questions Here </h1>
