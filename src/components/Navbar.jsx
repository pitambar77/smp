...
//               className="text-white sm:text-[15px] text-[10px] font-semibold text-sm px-5 py-3 hover:text-yellow-300 uppercase  border-b-1 border-gray-300 w-full"
//             >
//               {item.label}
//             </Link>
//           ))}
...
//           {menuOpen && (
//             <div className="md:hidden bg-[#447acc] text-black shadow-md font-[600] sm:text-[15px] text-[10px]">
...
//                       setMenuOpen(false);
//                     }}
//                     className={`w-full px-4 py-3 text-white font-semibold uppercase border-b-1 border-gray-300 bg-[#FF5254]`}
//                   >
//                     {link.label}
//                   </Link>
//                 ))}
...
//                       setShowForm(true);
//                     }}
//                     className="sm:w-full px-[10px] bg-[#FF5254] text-white sm:py-3 py-[10px] sm:text-[17px] text-[12px] rounded hover:bg-black hover:text-[#FF5254] transition"
//                   >
//                     REQUEST A FREE STRATEGY SESSION
//                   </button>

//                   {/* Phone number below button */}
//                   <div className="px-[15px] pb-6 pt-4 ml-10 text-center">
//                     <div className="flex text-white text-left items-center cursor-pointer hover:text-[#ff5254]">
//                       <img
//                         src={phonelogo}
//                         alt="Phone"
//                         className="h-4 sm:h-6 w-auto mr-2 filter invert brightness-0"
//                       />
//                       <p
//                         style={{ fontFamily: "Lato, sans-serif" }}
//                         className="sm:text-[18px] text-[14px] font-[600] leading-inherit"
//                       >
//                         +91 6371 223 581
//                       </p>
//                     </div>
