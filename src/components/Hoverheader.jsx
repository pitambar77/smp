...
export default function HeaderContainer() {
  ...
  const navItemWithDropdown = (label, id, isBold = false) => (
    ...
    >
      ...
      {openDropdown === id && (
        <div
          className="absolute left-0 z-50 text-sm text-gray-700 bg-white rounded-md shadow-lg top-full w-50"
          onMouseEnter={() => setOpenDropdown(id)}
          onMouseLeave={() => setOpenDropdown(null)}
        >
  ...
  shadow-[0_1px_7px_0_rgba(0,0,0,0.4)] sm:py-[15px] py-[10px]"
          >
            <div className=" max-w-[1140px] mx-auto md:px-2 xl:px-0">
              <div className="flex items-center justify-between px-4 sm:px-0">
                ...
                <div className="hidden md:block">
                  <nav className="relative z-50 hidden pt-1 m-0 bg-transparent md:block">
                    ...
                    {showForm && (
                      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 font-[Montserrat]">
                        <div className="relative w-[90%] max-w-[600px] bg-gradient-to-b from-[#427fdf] to-[#396bb1] rounded-lg shadow-lg animate-slide-down-fade">
                          ...
                          <div className="py-2 -mt-5 text-center text-white rounded-t-lg md:py-8">
                    ...
                    <div className="px-[15px] pb-6 pt-4 text-center">
                      <div className="flex text-white justify-center items-center hover:text-[#ff5254]">
                        <img
                          src={phonelogo}
                          alt="Phone"
                          className="w-auto h-6 mr-2 sm:h-6 filter invert brightness-0"
                        />
                        <p
