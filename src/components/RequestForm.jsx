  ...
  return (
    <>
      ...
      <form
        ...
        className="md:px-6 md:pb-8 space-y-2 mt-3   md:space-y-3"
      >
        <div className="grid grid-cols-1  sm:grid-cols-2 gap-[10px]">
          <input
            name="firstName"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-[10px]">
          <select
            name="selectServices"
            value={form.selectServices}
            onChange={handleChange}
            className="rounded  p-2  md:p-4 border border-white text-[15px] font-semibold w-full text-gray-600 bg-white hover:border-red-500"
          >
            <option value="">Select Services</option>
            <option value="Organic Marketing">Organic Marketing</option>
            <option value="Paid Advertising">Paid Advertising</option>
        ...
        {/* CAPTCHA */}
        <div className="mt-5 flex pb-5 pr-20 flex-col gap-[10px]">
          <ReCAPTCHA
            sitekey="6Lf2glwrAAAAAPsuvFIyVh24DbavfwihlL8CU2-Z"
            onChange={(token) => setCaptchaToken(token)}
          />
          <button className="bg-[#ff5254] md:w-1/2 text-[14px] py-3 cursor-pointer border border-[#ff5254] hover:bg-[#011833] hover:border-[#011833] duration-500 ease-in-out hover:text-[#ff5254] text-white md:px-[30px] md:py-3 rounded font-semibold">
            Get My Free Quote
          </button>
        </div>
      </form>
