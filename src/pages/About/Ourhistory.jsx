...
function Ourhistory() {
  ...
  return (
    <div className=" w-full ">
      <div className=" max-w-[1140px] px-3 md:px-0 mx-auto py-[50px] md:py-[100px]">
        <div className=" px-[15px]  ">
          <h3 className=" font-bold text-[24px] md:text-[48px] text-center capitalize text-[#3467d8] leading-[1.4]  pb-[15px]">
            Our History
          </h3>
          ...
          <div className=" mt-[30px]">
            <div>
              <h3 className="text-[15px] md:text-[22px] font-semibold  capitalize text-[#767676] leading-[1.3] pt-[10px] md:pb-[20px] pb-3">
                Our Mission
              </h3>
              <p className="text-[15px] md:text-[18px]  text-[#787878] leading-[1.5]  md:pb-[17px] text-justify ">
                Our Mission at Safari Marketing Pro is to (re)shape each safari
                and Tour Company so that they won’t have to rely on agents
              </p>
            </div>
            ...
            <div>
              ...
              <p className=" text-[15px] md:text-[18px] text-justify text-[#787878] leading-[1.5] m-0 pt-[15p  md:pb-[17px] pb-2">
                Building a recognizable brand is a crucial aspect of sustaining
                a business. Because this is the platform where most of the
                revenue will be generated.
              </p>
            ...
            <div>
              ...
              <p className="font-montserrat text-[20px] text-justify  text-[#4679c5] font-semibold  leading-[1.5] m-  md:pb-[17px] pb-2">
                Many individuals wondered why we wanted to work with Tour
                Operators in Africa! But, this decision wasn’t taken on impulse,
                we had a specific reason!
              </p>
            ...
            <div>
              <h3 className="text-[15px] md:text-[20px] font-semibold italic capitalize text-[#767676] leading-[1.3] pt-[10px] md:pb-[20px] pb-3">
                A Behind the scenes outlook
              </h3>
              <p className=" text-[15px] md:text-[18px] text-justify text-[#787878] leading-[1.5] m-0 pt-[15p  md:pb-[17px] pb-2">
                In 2012, there was a big hype about getting an easy project
            ...
            <div>
              <h3 className=" text-[22px] font-semibold  capitalize text-[#767676] leading-[1.3] pt-[10px] md:pb-[20px] pb-3">
                Challenges We Faced In The African Market
              </h3>
              <p className=" text-[15px] md:text-[18px] text-justify  text-[#787878] leading-[1.5] m-0 pt-[15p  md:pb-[17px] pb-2">
                It’s a fact that every organization has their ups and downs.
            ...
            <div>
              <h3 className=" text-[18px] md:text-[22px] font-semibold  capitalize text-[#767676] leading-[1.3] pt-[10px] md:pb-[20px] pb-3">
                How We Managed To Capture The Heart Of African Tour Operators{" "}
              </h3>
              <p className=" text-[15px] text-justify  md:text-[18px]  text-[#787878] leading-[1.5] m-0 pt-[15p  md:pb-[17px] pb-2">
                After we addressed the problems and did all the hard work, we
            ...
            <p className=" text-[15px] text-justify  md:text-[18px]  text-[#787878] leading-[1.5] m-  md:pb-[17px] pb-2">
              Even though we’ve received great recognition in the African
              Market, we don’t just want to settle in. We have even more visions
              on the horizon. Our ultimate goal is to reach every safari and
              tour operator in each corner of Africa and other continents. And
