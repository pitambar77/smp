            ...
            <div className="space-y-8 ">
                ...
                <div>
                    ...
                    <p className="font-[Montserrat] font-normal text-[18px] text-left text-[#787878] leading-[1.5] pt-[15px] pb-[17px] m-0">
                        With a detailed analysis of where your safari brand is positioned in the market, we curate paid ads that appear in front of your potential customers. After thoroughly testing to find the best conditions for your ads to succeed, we separate them as <strong className="font-[600]">Search And Display</strong>
                        Ads to get the most efficient results.
                    </p>

                    <p className="font-[Montserrat] font-normal text-[18px] text-left text-[#787878] leading-[1.5] pt-[15px] pb-[17px] m-0">
                        We apply deep <strong className="font-[600]">African Safari Keyword Research Technique</strong>s, and continuous A/B testing for what your safari customers are looking for. Then we take out the most valuable time of the entire day to showcase it to your qualified audience.
                    </p>
