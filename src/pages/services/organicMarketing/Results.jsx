...
const features = [
    {
        icon: (
            ...
            >
                <g>
                    ...
                    fill="#ff5254"
                    />
                    <path d="M758.9 655.7H704V743l69.4 68.8 38.6-39-53.1-52.7z" fill="#ff5254" />
                </g>
                </svg>
        ...
        description:
         ...
         description2:'Once we recognize how we bring more leads, we can strengthen that aspect and change all our SEO Strategies For African Safari Operators according to it.'
        },
    {
        icon: (
...
>
  <g>
    ...
    <path d="M5.58,11.29a.33.33,0,1,0,.34.33A.33.33,0,0,0,5.58,11.29Z" />
        ...
        description2:'As all of the content cannot reach the expected result or the number of leads, your website needs to produce efficient content that creates an impact.'
    },
...
>
  <g>
    <g>
      <path d="M135.955,290.443c-1.418-1.608-3.515-2.471-5.651-2.27c-2.137,0.18-4.062,1.361-5.19,3.185l-52.079,84.139
      ...
      <path d="M192.172,328.264c1.606,0,3.219-0.569,4.511-1.723l9.674-8.642c2.791-2.493,3.032-6.776,0.54-9.565
      ...
      <path d="M232.138,349.051l-12.69,2.686c-3.66,0.775-6,4.37-5.226,8.029c0.675,3.188,3.488,5.374,6.621,5.374
      ...
      <path d="M158.807,295.517c0.892,0.396,1.824,0.583,2.74,0.583c2.598,0,5.077-1.504,6.197-4.032l5.255-11.86
      ...
      <path d="M448.713,234.543c-5.912-9.696-13.34-18.296-22.075-25.56c-2.882-2.396-7.149-2-9.54,0.879
      ...
      <path d="M393.896,85.938c3.303-0.676,6.701-1.019,10.102-1.019c27.623,0,50.094,22.472,50.094,50.094
      ...
      <path d="M310.12,183.045c37.854,0,68.649-30.796,68.649-68.649s-30.796-68.649-68.649-68.649s-68.649,30.796-68.649,68.649
      ...
      <path d="M325.531,299.297c-22.498,2.42-45.268-0.57-66.303-8.629v-9.645c0-29.178,12.867-56.613,35.303-75.269
      ...
      <path d="M219.098,198.655c13.276,0,25.998-4.047,36.789-11.703c3.051-2.165,3.77-6.395,1.605-9.445
      ...
      <path d="M323.35,261.628c-4.219-4.218-11.065-4.218-15.284,0c-4.22,4.219-4.22,11.065,0,15.284
        c2.146,2.146,4.951,3.171,7.757,3.171c2.805,0,5.612-1.024,7.756-3.17C327.568,272.694,327.568,265.845,323.35,261.628z" />
      <path d="M282.289,238.515c-2.596,0-5.073,1.503-6.193,4.03c-1.075,2.42-0.484,5.165,1.511,7.04
      ...
      <path d="M319.042,215.988c-1.789-1.473-4.271-1.499-6.085-0.066c-1.816,1.434-2.497,4.021-1.459,6.227
