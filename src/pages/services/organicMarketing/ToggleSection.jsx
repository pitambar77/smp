    ...
    <>
        <div className=' w-full py-[80px]'>
            <div className=' max-w-[1140px] mx-auto '>
                    <div className=' max-w-[912px] mx-auto py-[20px]'>
                        <h1 className=' text-[#3467d8] text-[48px] font-[700] text-center pb-[15px]'>Providing Marketing Solutions to Solve Your Problems</h1>
                        <h2 className=" text-center text-[#787878] text-[22px] font-[400] leading-[1.4]">
            ...
            <div className=' max-w-[1140px] mx-auto '>
                ...
                <p className="max-w-md text-[#787878] font-[400] z-10 text-[17px] mt-10 ">
                    See to believe how doing end-to-end SEO can drive consistent traffic to your safari website in a long run.
                    It has been proved that 70% of the leads that come from organic searches have potential to convert.
                </p>

                {/* Main content */}
                <div className="flex flex-col md:flex-row items-center relative -mt-24">
                    {/* Left image */}
                    <div
                    ...
                    <div className="absolute md:static z-10 -mx-32">
                    <div className="flex items-center gap-20 md:mt-0">
                        <span className="text-sm md:text-base font-semibold text-gray-700">BEFORE SEO</span>
                        ...
                        <span className="text-sm md:text-base font-semibold text-gray-700">AFTER SEO</span>
                    </div>
                    </div>
