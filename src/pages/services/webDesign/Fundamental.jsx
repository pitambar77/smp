    ...
    return (
        <div>
            <div className="w-full h-full bg-[#f0f0f0] flex items-center justify-center px-4">
                <div className="max-w-[1140px] mx-auto text-center mt-15">
                    ...
                    <h6 className="font-[Montserrat] font-normal text-[22px] text-center capitalize text-[#787878] leading-[1.4] mb-7">
                        100 Percent Unique, Professional Website Design for Your Safari & Tours Business
                    </h6>
 
 
 
                    <p className=" font-[Montserrat] font-normal text-[17px] text-center text-[#787878] leading-inherit uppercase-normal px-[6%] pb-[20px]  ">
                        With everyone having an online presence, it’s a difficult job to stand out as a safari website. With our years of expertise in the safari industry, we have come out with these 6 points to have a superior website for your safari & tour brand.</p>
