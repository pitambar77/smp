...
const features = [
  {
    ...
    description: `Nowadays, the scope of your target audience is everywhere. With the growth in technology, your  African Safari Website also needs to compatible to every device so don’t miss out on an enquiry.`,
  },
  {
    icon: (
      <svg
  ...
  return (
    <div>
      <div className="w-full h-full bg-[#f0f0f0] flex items-center justify-center">
        <div className="sm:max-w-[1140px] mx-auto text-center mt-15 sm:px-0 px-4">
          <h2 className=" font-bold sm:text-[48px] text-[24px] text-center capitalize text-[#3467d8] leading-[1.4] m-0 px-0 sm:pb-[15px] pb-[10px]">
            The Fundamentals Of A Safari Website
          </h2>

          <h6 className=" font-normal text-[22px] text-center capitalize text-[#787878] leading-[1.4] mb-7">
            100 Percent Unique, Professional Website Design for Your Safari &
            Tours Business
          </h6>

          <p className=" sm:mx-[15px] -mx-4  text-[17px] text-center text-[#787878] leading-inherit uppercase-normal px-[6%] pb-[20px]  ">
            With everyone having an online presence, it’s a difficult job to
            stand out as a safari website. With our years of expertise in the
            safari industry, we have come out with these 6 points to have a
            superior website for your safari & tour brand.
          </p>
          ...
          <div className="mt-8">
            ...
            <div className="mt-12 text-center mb-22">
              <button
                ...
                className="bg-[#ff4d4d] text-white text-[14px] sm:text-[16px] font-semibold sm:px-6 px-[15px] sm:py-3 py-[10px]  rounded hover:bg-[#011833] ease-in duration-500 cursor-pointer hover:text-red-600 transition"
              >
