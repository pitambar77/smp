...
const Training = () => {
  ...
  return (
    <div className="">
      <Banner {...data} />
      <div className=" md:pt-23 pt-[40px] px-[15px] md:px-0  ">
        <div className="max-w-[1140px]  mx-auto  ">
          <div className=" flex md:flex-row flex-col   ">
            <div className=" basis-[40%] ">
              <img src={teamChinpal} alt="team" className=" " />
            </div>
            <div className=" basis-[60%]  md:px-[30px] py-[20px] md:py-[10px]">
              <div className=" ">
                <p className="pb-[15px] text-[#787878]  font-[600] text-[14px] md:text-[17px] text-base/6 text-justify  ">
                  Why should you listen to Safari Marketing Pro when it comes to
                  growing a consulting your Safari Business or having trouble
                  converting leads into Bookings?
                </p>
                <p className="pb-[15px] text-[#787878] font-[500] text-[14px] md:text-[17px] text-base/6 text-justify ">
                  Safari Marketing Pro delivers daily new customers to your
                  safari business through automated marketing systems. Our
                  Growth Formula focuses on actionable steps and results. We
                  support you at every step, from destination ideas to itinerary
                ...
                <div className=" md:grid md:grid-cols-2 md:gap-[20px] space-y-2 md:pt-[30px] text-[#787878]  text-[17px] ">
                  <div className="  flex ">
                    <span className=" mt-1 mr-[10px] ">
                      <FaCheckCircle className=" text-[#25abea] text-[16px] font-[400]" />
                    </span>
                  ...
                  <div className="  flex ">
                    ...
                    <p>
                      {" "}
                      <span className="font-[600] ">Lead Generation:</span>
                      Close deals without cold calling or hard selling.
                    </p>
                  </div>
                  ...
                  <div className="  flex ">
                    ...
                    <p>
                      <span className="font-[600] ">Presentation and Follow-Ups:</span>
                      Effectively present itineraries and provide tailored solutions.
                    </p>
                  </div>
                  ...
                  <div className="  flex ">
                    ...
                    <p>
                      <span className="font-[600] ">Operations: </span>
                       Add value to your destinations, ensuring steady and profitable growth.
                    </p>
                  </div>
                </div>
              </div>
