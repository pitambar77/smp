    ...
    const fetchBanner = async () => {
      try {
        const res = await axios.get(
          `${BASE_URL}/api/all-banners/offwegoCaseStudyBanner`
        );
      ...
      <SectionLayout>
        <div className="max-w-[60%] mx-auto text-center">
          ...
          <div className="mt-[50px] text-white">
            <Button link="https://offwegosafaris.com" label="Launch Project" />
          </div>
        </div>

        <ImageBlock src={offwego1} alt="laptop" />

        <TextImageSection
          title="Challenges Faced"
          image={{
            src: "https://safarimarketingpro.com/images/offwego-case-study2.png",
            alt: "challenge image",
          }}
          content={
            <>
              <p>
                Off We Go Safaris recognized the need to elevate their online
                presence to better reflect the uniqueness and quality of their
                safari experiences. They sought the expertise of Safari
                Marketing Pro to design a website that would not only showcase
                their offerings but also make a strong impression on their
                target audience.
              </p>
            </>
          }
        ...
        <TextImageSection
          ...
          image={{
            src: "https://safarimarketingpro.com/images/offwego-case-study3.png",
            alt: "solutions image",
          }}
          imageFirst
          content={
            <>
              <p>
                <strong>Visually Captivating Design:</strong> Safari Marketing
                Pro created a visually stunning website that conveyed the beauty
                and allure of East African safaris. High-quality imagery and
                captivating visuals were used to engage visitors and immerse
                them in the safari experience.
              </p>

              <p>&nbsp;</p>
              <p>
                <strong>Customization Features:</strong> A key element of the
                website design was the incorporation of an "Itinerary Builder."
                This interactive tool allowed visitors to customize their dream
                safaris, fostering a sense of ownership and anticipation. It
                also showcased Off We Go Safaris' commitment to tailoring
                experiences to individual preferences.
              </p>

              <p>&nbsp;</p>
              <p>
                <strong>Highlighting Luxury and Exclusivity: </strong> The
                website design emphasized the luxury camps and exclusive lodges
                in their collection, reinforcing the brand's dedication to
                providing a premium safari experience.
              </p>
            </>
          }
        />
        ...
        <TextImageSection
          ...
          image={{
            src: "https://safarimarketingpro.com/images/Luxury%20banner%205%20copy.png",
            alt: "results image",
          }}
          content={
            <p className="  leading-[1.5] text-[17px]">
              ...
              Safaris' brand reinforcement, lead generation, and sales
              conversion. The website now effectively communicates the
              uniqueness of their offerings, their customization capabilities,
              and the luxury of their safari experiences.
            </p>
          }
        />
