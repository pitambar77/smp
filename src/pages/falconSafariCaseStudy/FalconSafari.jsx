      ...
      <div className=" w-full">
        <div className=" max-w-[1020px] mx-auto mt-[60px] py-[29.45px]">
          ...
          <div className="mt-[40px]">
            <h1 className=" text-[#3467d8] font-[700] text-[30px] py-[15px] leading-[1.4] ">
              Safari Marketing Pro's Approach:
            </h1>
            <p className=" text-[#787878] font-[400] text-[17px] pb-[15px]">
            ...
            <p
              className=" text-[#626060]  font-[400] text-[16px]  text-center"
        ...
        <div className="">
          <div className=" max-w-[1020px] mx-auto mt-[60px] py-[29.45px]">
            <h1 className=" text-[#3467d8] font-[700] text-[40px] pb-[15px] px-[5%] leading-[1.3] text-center ">
              Key Strategies Implemented{" "}
            </h1>
            <p className=" text-[#787878] font-[400] text-[22px] pb-[15px] text-center">
            ...
            <div className=" grid grid-cols-2 justify-between p-[30px]">
              <div className="text-[#787878]  ">
                <p className="pb-[15px] flex items-center">
                  {" "}
                  <FaCheck className=" text-[#011833] font-[400] text-[16px] mr-[10px]" />{" "}
