...
const [bannerData, setBannerData] = useState(null);
  ...
  useEffect(() => {
    const fetchBanner = async () => {
      try {
        const res = await axios.get(`${ BASE_URL }/api/all-banners/lifetimeSafaris`);
      ...
      <div className=' w-full'>
         <div className=' max-w-[1140px] mx-auto mt-[60px] py-[29.45px]'>
            ...
            <div className=' max-w-[1050px] mx-auto px-[15px]'>
                ...
                <p className=' pb-[15px] text-[17px] text-[#787878] font-[400]'>Lifetime Safaris continues to partner with Safari Marketing Pro to strengthen its digital presence and achieve steady business growth.</p>
