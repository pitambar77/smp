  ...
  return (
    <div>
      ...
      <div className=' max-w-[1140px] mx-auto pt-[90px]  items-center justify-center text-center'>
        <h1 className=' capitalize  md:text-[40px] text-2xl text-[#3467d8] font-[700] sm:px-20 px-4 leading-[1.3] '>When your customers become your no.1 promoters</h1>
        <p  className=' px-4 py-4 text-cente text-[#787878] sm:text-[22px] text-[16px]  font-[400] '>Don’t just take our word for it. See what our clients are saying.</p>
      </div>
      </div>
      <div className=' w-full sm:px-0 px-4 '>
        <div className=' max-w-[1140px] mx-auto pb-[10px] p-[15px]'>
            
        <div className=' grid sm:grid-cols-1 md:grid-cols-2 sm:gap-[30px] gap-[10px]  items-center'>
         <div className='bg-[url(https://i.ytimg.com/vi_webp/n6JyE-KVCsE/maxresdefault.webp)] sm:h-[304px] bg-cover bg-bg-center'>
