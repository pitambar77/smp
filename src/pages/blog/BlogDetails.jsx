  ...
  return (
    ...
    <HeaderContainerBlue/>
      <div className=" mt-20">
        ...
        <div
          className="relative mt-25  w-full bg-white bg-no-repeat bg-top bg-contain flex justify-center items-center "
          style={{
            backgroundImage:
              `url(${vector})`,
          }}
        ...
        <div className=" max-w-[1140px] mx-auto  flex justify-between mt-30 relative ">
          <div className=" max-w-[700px] ">
            ...
            <div className="bg-teal-400 text-center rounded-lg py-10 px-6 mt-5">
      ...
      className="bg-purple-600 text-white text-lg font-semibold px-8 py-3 rounded-lg hover:bg-purple-700 transition duration-300">
        Contact Us Today!
      </button>
    </div>
            ...
            <p className=" font-normal sm:text-[18px] text-[14px] sm:text-left text-justify text-[#787878] leading-[1.5] sm:pt-[15px]  m-0 ">
             ...
             <div className="bg-teal-900 text-center rounded-lg py-10 px-6 mt-5">
      <p className="text-gray-100 text-lg md:text-xl mb-6">
        <em className="font-medium">
          ebsite isn’t showing up in these AI-generated summaries
        </em>{" "}
        Speak with our SEO experts today to ensure your site ranks locally.
      </p>
      <button 
...
//         axios
//           .get(`${BASE_URL}/api/blogs?category=${res.data.category}`)
//           .then((relatedRes) => {
//             const filtered = relatedRes.data.filter((b) => b._id !== res.data._id);
...
//           <h1 className="text-left font-montserrat font-bold text-[40px] md:text-[60px] capitalize text-[#3467d8] leading-[1.2]">
//             {blog.title}
//           </h1>
//         </div> */}
...
//         {/* Hero Image */}
//         {/* <div
//           className="relative mt-20 w-full bg-white bg-no-repeat bg-top bg-contain flex justify-center items-center"
...
//         <div className="max-w-[1140px] mx-auto flex justify-between mt-20 relative px-4">
//           {/* Main Blog Content */}
//           <div className="max-w-[700px]">
//             <div
...
//               </span>
//               <span className="flex items-center gap-1">
//                 <SlCalender /> {new Date(blog.createdAt).toDateString()}
//               </span>
//             </p>
//           </div>

//           {/* Sidebar */}
//           <div className="max-w-[350px] h-fit sticky top-30 self-start hidden lg:block">
//             <Sidebar />
//           </div>
//         </div>
...
//                         </span>
//                         <span className="flex items-center gap-1">
//                           <SlCalender size={12} /> {new Date(post.createdAt).toDateString()}
//                         </span>
//                       </div>
//                     </div>
//                   </div>
