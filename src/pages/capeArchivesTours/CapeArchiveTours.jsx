...
const CapeArchiveTours = () => {
  ...
  useEffect(() => {
    const fetchBanner = async () => {
      try {
        const res = await axios.get(`${ BASE_URL }/api/all-banners/capeachiveTour`);
  ...
  return (
    ...
    <SectionLayout>
      ...
      <TextImageSection
        ...
        image={{ src: 'https://safarimarketingpro.com/images/capearchivestours-case-study2.png', alt: 'challenge image' }}
        content={
          <>
            <p><strong>Competitive Travel Market: </strong> The travel industry is fiercely competitive, with travelers seeking exceptional experiences. Cape Archives Tours needed to stand out in this crowded market.</p>
            <p>&nbsp;</p>
            ...
            <p>&nbsp;</p>
            <p><strong>Building Trust:</strong> Establishing trust was essential, as travelers often invest substantial sums in their experiences. Cape Archives Tours needed to showcase its expertise and build confidence.</p>
      ...
      <TextImageSection
        ...
        image={{ src: 'https://safarimarketingpro.com/images/capearchivestours-case-study3.png', alt: 'solutions image' }}
        imageFirst
        content={
          <>
            <p><strong>Unveiling Unprecedented Luxury:</strong></p>
            <p>&nbsp;</p>
            <p>Immersive Visuals: The new website introduced visitors to the unparalleled luxury of Cape Archives Tours with full-screen, high-quality imagery and captivating videos, promising an unforgettable adventure.</p>
            <p>&nbsp;</p>
            <p><strong>Personalized Itinerary Building:</strong></p>
            <p>&nbsp;</p>
            <p>Itinerary Builder: A key feature, the "itinerary builder," allowed visitors to customize their dream trips, fostering a sense of ownership and anticipation.</p>
            <p>&nbsp;</p>
             <p><strong>Building Trust and Confidence:</strong></p>
             <p>&nbsp;</p>
            <p>Trust Signals: Strategically placed client reviews, endorsements, and awards instilled trust in Cape Archives Tours’ expertise."Travel with Confidence" Messaging: Throughout the user journey, the website reinforced the brand's commitment to excellence with messages like "travel with confidence."</p>
          </>
        }
      />
      ...
      <TextImageSection
        ...
        image={{ src: 'https://safarimarketingpro.com/images/capearchivestours-case-study4.png', alt: 'results image' }}
        content={
          <p>The final website isn't just a digital presence; it's a gateway to a once-in-a-lifetime experience for travelers. It significantly contributed to Cape Archives Tours' brand reinforcement, lead generation, and sales conversion. The website doesn't just showcase luxury; it embodies it, making it a game-changer in the industry.</p>
        }
      />
      ...
      <div className="max-w-[75%] mx-auto">
        {["cape1.png", "cape2.png", "cape3.png", "cape4.png", "cape5.png","cape6.png","cape7.png"].map((img, idx) => (
          <img
            key={idx}
