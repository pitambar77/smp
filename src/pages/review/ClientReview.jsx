...
const ClientReview = () => {
  return (
     <div className=" w-full  md:pt-[80px]  pt-[40px]  md:pb-[10px]">
        <div className=" max-w-[1172px] mx-auto  items-center justify-center text-center">
          <h1 className=" capitalize   md:text-[48px] text-2xl text-[#3467d8] font-[700] px-4 md:px-[10%] pb-[10px]  leading-[1.3] ">
