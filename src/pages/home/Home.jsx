  ...
  return (
    <div className=' '>
      ...
      <div className=' max-w-[1140px] mx-auto pt-10  items-center justify-center text-center'>
            <h1 className=' capitalize   md:text-[48px] text-2xl text-[#3467d8] font-[700] md:px-20 px-4 leading-[1.3] '>See What Our Clients Are Saying
About Our Services</h1>
          
          </div>
          <div className="max-w-5xl mx-auto py-8 px-8 bg-gray-50">
            <h2 className="text-[24px] font-[400] text-[#17313b] pb-4 mb-[17px] hover:underline">
