...
const images = [
  {
    ...
    image: "https://safarimarketingpro.com/images/africanscenic-casestudy8.png",
   
  },
  {
   
    image: "https://safarimarketingpro.com/images/africanscenic-casestudy9.png",
   
  },
  {
   
    image: "https://safarimarketingpro.com/images/africanscenic-casestudy6.png",
   
  },
  {
  image:"https://safarimarketingpro.com/images/africanscenic-casestudy7.png",
...
const AfricanScenic = () => {
 ...
 <div className=" max-w-[1050px] mx-auto sm:px-0 px-4 py-[29.45px] ">
          <h1 className=" text-[#011833] font-[600] sm:text-[22px] text-[18px] text-center pb-10">
            Key Metric 3: Top Ranking Keywords
          </h1>
